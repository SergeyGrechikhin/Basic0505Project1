...
public class TeaCollection {
    ...
    public Tea add(Tea newTea){
        /*
        в экземпляре класса basicjava.tea, ссылку на который будут передавать в этот метод,
...
//            if (teas[i] == null) {
//                Tea basicjava.tea = new Tea(teaIndex,
//                        newTea.getManufacturer(),
//                        newTea.getType(),
//                        newTea.getVariety());
//                teaIndex++;
//
//                teas[i] = basicjava.tea;
//                return basicjava.tea;
//            } else {
//                return null;
//            }
//
